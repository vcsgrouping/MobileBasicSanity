...
public interface RegionsService {
     ...
     */
    Regions create(@Valid Regions regions);
     ...
     */
    Regions getById(BigInteger regionsId);
     ...
     * @return Regions associated with the given regionsId.
     */
    Regions findById(BigInteger regionsId);

	/**
     * Find and return the list of Regions by given id's.
     *
     ...
     *
     * @param regionsIds The id's of the Regions to get; value cannot be null.
     * @param orderedReturn Should the return List be ordered and positional in relation to the incoming ids?
     * @return Regions associated with the given regionsIds.
     */
    List<Regions> findByMultipleIds(List<BigInteger> regionsIds, boolean orderedReturn);
     ...
     */
    Regions delete(BigInteger regionsId);

    /**
     * Deletes an existing Regions with the given object.
     *
     * @param regions The instance of the Regions to be deleted; value cannot be null.
     */
    ...
    /*
     * Returns the associated countrieses for given Regions id.
     *
     * @param regionId value of regionId; value cannot be null
     * @param pageable Details of the pagination information along with the sorting options. If null returns all matching records.
     * @return Paginated list of associated Countries instances.
     *
     * @see Pageable
     * @see Page
     */
    Page<Countries> findAssociatedCountrieses(BigInteger regionId, Pageable pageable);
