...
import com.mobilebasicsanity.wmstudio.service.DepartmentsService;
...
public class DepartmentsController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Departments getDepartments(@PathVariable("departmentId") Short departmentId) {
        LOGGER.debug("Getting Departments with id: {}" , departmentId);

        Departments foundDepartments = departmentsService.getById(departmentId);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Departments editDepartments(@PathVariable("departmentId") Short departmentId, @RequestBody Departments departments) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Departments patchDepartments(@PathVariable("departmentId") Short departmentId, @RequestBody @MapTo(Departments.class) Map<String, Object> departmentsPatch) {
        LOGGER.debug("Partially updating Departments with id: {}" , departmentId);

        Departments departments = departmentsService.partialUpdate(departmentId, departmentsPatch);
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteDepartments(@PathVariable("departmentId") Short departmentId) {
        LOGGER.debug("Deleting Departments with id: {}" , departmentId);

        Departments deletedDepartments = departmentsService.delete(departmentId);
	...
	@ApiOperation(value = "Returns the total count of Departments instances matching the optional query (q) request param.")
    ...
    @RequestMapping(value="/{departmentId:.+}/employeesesForDepartmentId", method=RequestMethod.GET)
    @ApiOperation(value = "Gets the employeesesForDepartmentId instance associated with the given id.")
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Page<Employees> findAssociatedEmployeesesForDepartmentId(@PathVariable("departmentId") Short departmentId, Pageable pageable) {

        LOGGER.debug("Fetching all associated employeesesForDepartmentId");
        return departmentsService.findAssociatedEmployeesesForDepartmentId(departmentId, pageable);
    }

    @RequestMapping(value="/{departmentId:.+}/jobHistories", method=RequestMethod.GET)
    @ApiOperation(value = "Gets the jobHistories instance associated with the given id.")
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Page<JobHistory> findAssociatedJobHistories(@PathVariable("departmentId") Short departmentId, Pageable pageable) {

        LOGGER.debug("Fetching all associated jobHistories");
        return departmentsService.findAssociatedJobHistories(departmentId, pageable);
    }
