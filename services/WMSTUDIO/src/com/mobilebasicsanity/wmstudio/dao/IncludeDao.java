...
/**
 * Specifies methods used to obtain and modify Include related information
 * which is stored in the database.
 */
@Repository("WMSTUDIO.IncludeDao")
public class IncludeDao extends WMGenericDaoImpl<Include, IncludeId> {
