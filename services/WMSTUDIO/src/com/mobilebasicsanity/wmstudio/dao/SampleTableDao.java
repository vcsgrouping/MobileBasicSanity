...
/**
 * Specifies methods used to obtain and modify SampleTable related information
 * which is stored in the database.
 */
@Repository("WMSTUDIO.SampleTableDao")
public class SampleTableDao extends WMGenericDaoImpl<SampleTable, SampleTableId> {
