...
/**
 * Specifies methods used to obtain and modify Jobs related information
 * which is stored in the database.
 */
@Repository("WMSTUDIO.JobsDao")
public class JobsDao extends WMGenericDaoImpl<Jobs, String> {
