...
/**
 * Specifies methods used to obtain and modify Nopk related information
 * which is stored in the database.
 */
@Repository("WMSTUDIO.NopkDao")
public class NopkDao extends WMGenericDaoImpl<Nopk, BigInteger> {
